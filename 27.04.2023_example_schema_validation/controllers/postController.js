...
export const createPost = async(req, res) => {
    try {
        ...
        return res.status(StatusCodes.CREATED).json({message:'Post created', createdPost:createdPost})
        ...
        return res.status(StatusCodes.BAD_REQUEST).json({message:'Error happened', error:error.toString()})
    }
}
